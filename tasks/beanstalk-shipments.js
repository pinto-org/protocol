...
task(
  "runBeanstalkShipments",
  "Runs all beanstalk shipment deployment steps in sequential order"
)
  ...
  .setAction(async (taskArgs) => {
    ...
    try {
      ...
      await pauseIfNeeded("Press Ctrl+C to stop, or press Enter to continue after multisig execution...");
      ...
      await pauseIfNeeded("Press Ctrl+C to stop, or press Enter to continue after necessary approvals...");
